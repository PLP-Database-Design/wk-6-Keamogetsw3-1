...
def test_web_interaction():
    ...
    try:
        ...
        driver.get("https://cautious-waddle-5699g4wxx7q2v4q6-3000.app.github.dev/")
        
        # Wait up to 30 seconds for the "Register" link to be clickable before interacting
        ...
        print("Current URL after clicking Register:", driver.current_url)
        
        # Verify that the current URL contains "register" to confirm navigation was successful
        assert "Register" in driver.current_url.lower(), "Navigation to Register failed"
