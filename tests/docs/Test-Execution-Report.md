...
| Test Case ID | Objective                                                              | Test Type | Expected Result                                                        | Actual Result | Status | Defect ID | Severity | Tester | Date |
| ------------ | ---------------------------------------------------------------------- | --------- | ---------------------------------------------------------------------- | ------------- | ------ | --------- | -------- | ------ | ---- |
| TC136        | Verify date selection rejects today and past dates   allows minimum date (tomorrow)                    | Automated | Dates today and earlier are rejected with validation message           |               |    Fail ❌    |           | High     |        |      |
| TC137        | Verify date selection rejects dates beyond 30 days                     | Automated | Dates >30 days from today are rejected with validation message         |               |  Fail ❌ |           | High     |        |      |
| TC138        | Verify name field accepts 2-50 characters                              | Automated | Names with <2 or >50 characters are rejected; valid length is accepted |               |  Fail ❌  |           | Medium   |        |      |
| TC139        | Verify email field accepts valid format                                | Automated | Invalid email formats are rejected; valid emails accepted              |               |  Pass ✅  |           | High     |        |      |
| TC140        | Verify password field enforces minimum 8 characters                    | Automated | Passwords <8 characters are rejected                                   |               |  Fail ❌  |           | High     |        |      |
| TC141        | Verify instructions field accepts 0-200 characters                     | Automated | Instructions exceeding 200 characters are rejected                     |               | Fail ❌  |           | Medium   |        |      |
| TC144        | Verify special characters in name/email/instructions                   | Automated | System accepts valid special characters in inputs without errors       |               | Pass ✅  |           | Medium   |        |      |
| TC145        | Verify Unicode and international characters in name/email/instructions | Automated | System accepts Unicode and international characters correctly          |      Cannot email with symbol         | Fail ❌   |           | Medium   |        |      |
| TC146        | Verify very long inputs are rejected                                   | Automated | Inputs exceeding maximum length are rejected with validation           |               | Fail ❌  |           | High     |        |      |
| TC147        | Verify empty or whitespace-only inputs are rejected                    | Automated | Inputs that are empty or whitespace-only are rejected                  |               | Pass ✅    | —         | —        |Keamogetswe | 2025-11-17 |
